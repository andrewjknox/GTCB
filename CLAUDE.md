...
5. Plan targets live in `data/plan.json` (per-week vert targets + `tof_target_h` [min,max] hour ranges, phase labels W1–23) — hand-maintained, agents read-only. (`tof_target_h` added 2026-07-12 at the owner's request, transcribed from the ToF column of `site/plan.html`; W23 has none.)
